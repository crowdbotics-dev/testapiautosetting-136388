...
class Testconnectors136388ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS136388_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS136388_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS136388"
